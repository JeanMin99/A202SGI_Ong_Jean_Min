...
public class ApprovedLeaveRequest extends Fragment {
    ...
    public void buttonSubmit_Clicked1()
    {
        ...
        // To access leave of absence data
        ArrayList<Info_RequestData> data_with_Notes=new ArrayList<Info_RequestData>();

        Cursor cursor=_db.getApprovedLeaveRequest(); //To access to database function
